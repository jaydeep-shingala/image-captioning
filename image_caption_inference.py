...
image_path = "/data/home/jaydeeps/ImageCaptioning/flickr8k/images/33108590_d685bfe51c.jpg"
...
# image_features = [tensor for tensor in image_features]
# tensors = image_features[0]
...
captions = [""]    
dataset = TextDataset([tensors], [captions])
# print(len(dataset))
# print(dataset[1])
...
#     print("predicted Caption: ", predicted_sentence)
    kn_sentence = ("",)
    eng_sentence = (tensors,)
    print(eng_sentence[0].shape)
    for word_counter in range(max_sequence_length):
        encoder_self_attention_mask, decoder_self_attention_mask, decoder_cross_attention_mask= create_masks(eng_sentence, kn_sentence)
        predictions = transformer(eng_sentence[0],
                                    kn_sentence,
                                    encoder_self_attention_mask.to(device), 
                                    decoder_self_attention_mask.to(device), 
                                    decoder_cross_attention_mask.to(device),
        ...
        if next_token == END_TOKEN:
            break
    print("Predicted Sentence: ", kn_sentence)
print("******DONE*******")